...
lvim.builtin.which_key.mappings["n"] = {
  ...
  q = { "<cmd>ObsidianQuickSwitch<cr>", "QuickSwitch note" },
...
local m_mappings = {
  ...
  ["1"] = { '<cmd>lua require("harpoon.ui").nav_file(1)<cr>', "Navigate to item 1" },
  ["2"] = { '<cmd>lua require("harpoon.ui").nav_file(2)<cr>', "Navigate to item 2" },
  ["3"] = { '<cmd>lua require("harpoon.ui").nav_file(3)<cr>', "Navigate to item 3" },
  ["4"] = { '<cmd>lua require("harpoon.ui").nav_file(4)<cr>', "Navigate to item 4" },
  t = {
    ["1"] = { '<cmd>lua require("harpoon.term").gotoTerminal(1)<cr>', "Open terminal 1" },
    ["2"] = { '<cmd>lua require("harpoon.term").gotoTerminal(3)<cr>', "Open terminal 2" },
    ["3"] = { '<cmd>lua require("harpoon.term").gotoTerminal(3)<cr>', "Open terminal 3" },
  }
}
